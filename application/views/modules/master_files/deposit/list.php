					...
					<div class="card-head">
						...
						<div class="card-head-tools">
							<ul class="tools-list">
								...
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Print" onclick="popUp('<?php echo site_url('deposit/printlist') ?>', 800, 500)"><i class="la la-print"></i></button>
								</li>
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Export to Excel File" onclick="window.location='<?php echo site_url('deposit/exportlist') ?>';"><i class="la la-file-excel-o"></i></button>
								</li>
							</ul>
						</div>
					</div>
								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    array('column_header'=>'Acount Name','column_field'=>'accountName','width'=>'w-15','align'=>''),
													array('column_header'=>'Email','column_field'=>'email','width'=>'w-15','align'=>''),
													array('column_header'=>'Amount','column_field'=>'amount','width'=>'w-5','align'=>'r'),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<select class="form-control" id="bankAccountID" name="bankAccountID" data-live-search="true" liveSearchNormalize="true" style="width:100px">
													<option value="">&nbsp;</option>
													<?php 
											...
											<th class="form-group form-input">
												<input type="text" class="form-control" id="email" name="email" style="width:200px" value="<?php echo $email ?>">
											</th>
											<th class="form-group form-input">
									...
									<tbody>
										<?php 
											if (count($records)) {
											    ...
											    ?>
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->depositID); ?>'">
