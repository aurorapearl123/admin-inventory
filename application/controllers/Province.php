...
class Province extends CI_Controller {
	...
	public function __construct() {
		...
		$this->data['controller_page'] = $this->controller_page = site_url('province'); // defines contoller link
		$this->table = 'provinces'; // defines the default table
		$this->pfield = $this->data['pfield'] = 'provinceID'; // defines primary key
		$this->logfield = 'province';
		$this->module_path = 'modules/'.strtolower(str_replace(" ", "_", $this->module)) . '/Province'; // defines module path
	...
	private function submenu() {
		...
		$this->data['current_module'] = $this->modules[$this->module]['sub']['Province']; // defines the current sub module
		// check roles
		$this->check_roles ();
	...
	public function show() {
		...
		$condition_fields = array (
			...
			array ('variable' => 'province', 'field' => $this->table . '.province', 'default_value' => '', 'operator' => 'like_both' ), 
		...
		// sorting fields
		$sorting_fields = array ('province' => 'asc' );
