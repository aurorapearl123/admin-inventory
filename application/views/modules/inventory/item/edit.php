							...
							<tbody>
								<tr>
									...
									<td class="form-group form-input" width="400px">
										<input class="form-control"type="text" class="form-control" id="itemCode" name="itemCode" value="<?php echo $rec->itemCode?>" title="Item Code" required>
									</td>
								...
								<tr>
									...
									<td class="form-group form-input" width="400px">
										<select id="subcatID" name="subcatID" class="form-control" data-live-search="true" liveSearchNormalize="true">
											<option value="" selected>&nbsp;</option>
											<?php 
											$this->db->where('status',1);
											$records = $this->db->get('subcategory')->result();
											foreach($records as $row){
											?>
											<option value="<?php echo $row->subcatID?>" <?php if($row->subcatID == $rec->subcatID){echo "selected";}?>><?php echo $row->subcatdesc?></option>
											<?php }?>
										</select>
									</td>
									<td>&nbsp;</td>
								...
								<tr>
									...
									<td class="form-group form-input">
										<select id="brandID" name="brandID" class="form-control" data-live-search="true" liveSearchNormalize="true">
											...
											foreach($records as $row){
											?>
											<option value="<?php echo $row->brandID?>" <?php if($row->brandID == $rec->brandID){echo "selected";}?>><?php echo $row->brand?></option>
											<?php }?>
										</select>
									</td>
									<td>&nbsp;</td>
					...
					<div class="table-row">
						<table class="table-form column-3">
						    <tr>   
						        ...
						        <table>
							        	<tr>
							        		<td width="25"><input name="inventoryType" id="inventoryType" type="radio" value="1" <?php if($rec->inventoryType == 1){echo "checked";}?>></td>
								        	<td width="25">Inventory</td>
								        	<td width="25"><input name="inventoryType" id="inventoryType" type="radio" value="0" <?php if($rec->inventoryType == 0){echo "checked";}?>></td>
						    ...
						    <tr>   
						        ...
						        <table>
							        	<tr>
							        		<td width="25"><input name="dangerousDrug" id="dangerousDrug" type="checkbox" value="1" <?php if($rec->dangerousDrug == 1){echo "checked";}?>></td>
						        ...
						        <table>
							        <tr>
							        	...
							        	<td width="25">Non-Vatable&nbsp;&nbsp;&nbsp;</td>
					      				<td width="10"><input name="vatType" id="vatType" type="radio" value="2" <?php if($rec->vatType == 2){echo "checked";}?>></td>
							        	<td width="25"align="center" nowrap>Zero-Rated&nbsp;&nbsp;&nbsp;</td>
							        	<td width="10"><input name="vatType" id="vatType" type="radio" value="3" <?php if($rec->vatType == 3){echo "checked";}?>></td>
						    ...
						    <tr>   
						        ...
						        <table>
							        <tr>
						        		<td width="25"><input name="discountable" id="discountable" type="radio" value="1" <?php if($rec->discountable == 1){echo "checked";}?>></td>
							        	<td width="25">Yes&nbsp;&nbsp;&nbsp;</td>
					      				<td width="25"><input name="discountable" id="discountable" type="radio" value="0" <?php if($rec->discountable == 0){echo "checked";}?>></td>
