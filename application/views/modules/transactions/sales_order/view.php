						...
						<table class="view-table">
							...
							<!-- Table Rows Start -->
								<tr>
									...
									<td class="data-title" style="width:120px" nowrap>S.O. No:</td>
								...
								<tr>
									...
									<td class="data-input" nowrap><?php echo $rec->soDate == '0000-00-00' ? '' :date('M d,Y',strtotime($rec->soDate)); ?></td>
									<td class="data-title"></td>
								</tr>
								<tr>
									<td class="data-title" style="width:120px" nowrap>P.O. No:</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->poNo; ?></td>
									<td class="data-title" style="width:120px" nowrap>P.O. Date:</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->poDate == '0000-00-00' ? '' :date('M d,Y',strtotime($rec->poDate)); ?></td>
									<td class="data-title"></td>
								</tr>
								<tr>
									<td class="data-title" style="width:120px" nowrap>Delivery Date:</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->deliveryDate == '0000-00-00 00:00:00' ? '' :date('M d,Y',strtotime($rec->soDate)); ?></td>
									<td class="data-title" style="width:120px" nowrap>Delivery Term:</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->deliveryTerm; ?></td>
									<td class="data-title"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->dueDate == '0000-00-00 00:00:00' ? '' :date('M d,Y',strtotime($rec->soDate)); ?></td>
