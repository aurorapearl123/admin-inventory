						...
						<table class="view-table">
							...
							<!-- Table Rows Start -->
								<tr>
									...
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->drDate == '0000-00-00' ? '' :date('M d,Y',strtotime($rec->drDate)); ?></td>
								...
								<tr>
									...
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->departure == '0000-00-00 00:00:00' ? '' :date('M d,Y',strtotime($rec->departure)); ?></td>
									<td class="data-title"></td>
								</tr>
								<tr>
									...
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->soNo; ?></td>
									<td class="data-title"></td>
								</tr>
...
<script>
	...
	function confirm_record(status='') {
		...
		var id = "<?php echo $rec->drID; ?>";
		var soID = "<?php echo $rec->soID; ?>";
		var custID = "<?php echo $rec->custID; ?>";
		swal({
		...
		.then((willDelete) => {
			if (willDelete.value) {
				...
				$.post("<?php echo $controller_page; ?>/confirm_record", { id: id, status: status, soID: soID, custID: custID },
					function(response){ 
