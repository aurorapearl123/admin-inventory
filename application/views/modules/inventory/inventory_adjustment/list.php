                                ...
                                <table class="table table-striped hover">
									<thead align="">
										<tr class="thead-light" align="center">
											<?php 
												...
												$headers = array(
												    ...
												    // array('column_header'=>'Office / Dept','column_field'=>'officeName','width'=>'w-10','align'=>'left'),
												    array('column_header'=>'Item Name','column_field'=>'name','width'=>'w-20','align'=>''),
												    array('column_header'=>'Quantity','column_field'=>'qty','width'=>'w-5','align'=>''),
												    array('column_header'=>'Unit','column_field'=>'umsr','width'=>'w-5','align'=>''),
												    array('column_header'=>'Adjustment Type','column_field'=>'adjType','width'=>'w-5','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse show">
											...
											<th class="form-group form-input">
												<input type="text" class="form-control" id="adjNo" name="adjNo" value="<?php echo $adjNo ?>">
											</th>
											<!-- <th class="form-group form-input">
											...
											<th class="form-group form-input">
												<input type="text" class="form-control" id="umsr" name="umsr" value="<?php echo $umsr ?>">
											</th>
											<th class="form-group form-input">

												<select class="form-control" id="adjType" name="adjType">
													<option value="">&nbsp;</option>
													<option value="DR" <?php if($adjType == "DR") echo "selected"; ?>>Increase</option>
													<option value="CR" <?php if($adjType == "CR") echo "selected"; ?>>Decrease</option>
												</select>
									...
									<tbody>
										...
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->adjID); ?>'">											
											<td align="center"><?php echo $row->adjNo ?></td>
											<td><?php echo date('M d, Y', strtotime($row->dateInserted))   ?></td>
											<!-- <td><?php //echo $row->officeName ?></td> -->
											<td><?php echo $row->name.' '.$row->description ?></td>
