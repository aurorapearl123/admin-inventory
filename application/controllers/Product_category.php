...
class Product_category extends CI_Controller {
	...
	public function __construct() {
		...
		$this->data['controller_page'] = $this->controller_page = site_url('Product_category'); // defines contoller link
		$this->table = 'category'; // defines the default table
		$this->pfield = $this->data['pfield'] = 'catID'; // defines primary key
		$this->logfield = 'catID';
		$this->module_path = 'modules/'.strtolower(str_replace(" ", "_", $this->module)) . '/Product_category'; // defines module path
	...
	private function submenu() {
		...
		$this->data['current_module'] = $this->modules[$this->module]['sub']['Product Category']; // defines the current sub module
		// check roles
		$this->check_roles ();
	...
	public function show() {
		...
		// sorting fields
		$sorting_fields = array ('category' => 'asc' );
