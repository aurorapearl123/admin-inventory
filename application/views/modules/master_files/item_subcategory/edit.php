	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				...
				<div class="card-body">
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url('item_subcategory/update') ?>">
						<input type="hidden" name="subcatID" id="subcatID" value="<?php echo $this->encrypter->encode($rec->subcatID) ?>" />
						<div class="table-row">
								...
								<tbody>
									<tr>
										...
										<td class="form-group form-input" width="400px" nowrap>
											<select  class="form-control" name="catID" id="catID" title="Category" required>
											...
											?>
												<option value="<?php echo $row->catID ?>" <?php echo $row->catID == $rec->catID? 'selected' : '' ?>><?php echo $row->category?></option>	
											<?php } ?>
										</select>
									...
									<tr>
										...
										<td class="form-group form-input" width="400px" nowrap>
											<input type="text" class="form-control" name="subcatdesc" id="subcatdesc" title="Description" value="<?php echo $rec->subcatdesc?>" required>
										</td>
										<td class="d-xxl-none"></td>
									</tr>
									<tr>
...
<script>
	...
	$('#cmdCancel').click(function(){
	    ...
	    .then((willDelete) => {
	      if (willDelete.value) {
	    	  window.location = '<?php echo site_url('item_subcategory/view/'.$this->encrypter->encode($rec->subcatID)) ?>';
	      }
	    });
	});
</script>
