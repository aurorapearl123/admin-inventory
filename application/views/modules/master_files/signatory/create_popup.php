								...
								<tbody>
									<tr>
										...
										<td class="form-group form-input" width="400px" nowrap>
											<input type="text" class="form-control" name="fullname" id="fullname" maxlength="6" title="Name" style="width:100px" required>
										</td>
										<td>&nbsp;</td>
									</tr>
									<tr>
...
<script>
	$('#cmdSave').click(function(){
		if (check_fields()) {
	        ...
	        $.post("<?php echo $controller_page ?>/check_duplicate", { fullname: $('#fullname').val() },
	          function(data){
	            if (parseInt(data)) {
