	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				...
				<div class="card-body">
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url("city/save") ?>">
								...
								<tbody>
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" name="city" id="city" title="City" required>
										</td>
										<td class="d-xxl-none"></td>
									</tr>
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" name="zipcode" id="zipcode" title="Zipcode" required>
										</td>
										<td class="d-xxl-none"></td>
									</tr>
									<tr>
...
<script>
	$('#cmdSave').click(function(){
		if (check_fields()) {
	        ...
	        $.post("<?php echo $controller_page ?>/check_duplicate", { city: $('#city').val() },
	          function(data){
	            if (parseInt(data)) {
	...
	$('#cmdCancel').click(function(){
		swal({
		    ...
		    .then((willDelete) => {
		      if (willDelete.value) {
		    	  window.location = '<?php echo site_url('city/show') ?>';
		      }
		    });
