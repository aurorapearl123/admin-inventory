				...
				<div class="card-head">
					...
					<div class="card-head-tools">
						<ul class="tools-list">
							...
							<?php if ($roles['edit']) {?>
							<li>
								<a href="<?php echo $controller_page.'/edit/'.$this->encrypter->encode($rec->bankID) ?>" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit"><i class="la la-edit"></i></a>
							</li>
							<?php } ?>
							<?php if ($roles['delete'] && !$in_used) {?>
							<li>
								<button name="cmddelete" id="cmddelete" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" data-original-title="Delete" onclick="deleteRecord('<?php echo $this->encrypter->encode($rec->bankID); ?>');"><i class="la la-trash-o"></i></button>
							</li>
							<?php } ?>
					...
					<div class="data-view">
						<table class="view-table">
							...
							<!-- Table Rows Start -->								
								...
								<tr>
									<td class="data-title" style="width:120px" nowrap>Bank Acronym:</td>
									<td class="data-input" nowrap><?php echo $rec->bankAcronym; ?></td>
									<td class="data-title"></td>
									<td class="data-title"></td>
								</tr>							
								<!-- Table Rows End -->
