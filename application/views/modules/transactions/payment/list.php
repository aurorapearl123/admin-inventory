								...
								<table align="left" class="table table-striped hover">
									<thead>
										<tr>
											...
											<?php 
												$headers = array(
												    array('column_header'=>'Payment No','column_field'=>'paymentNo','width'=>'w-10','align'=>''),
												    array('column_header'=>'Payment Date','column_field'=>'paymentDate','width'=>'w-10','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="paymentNo" name="paymentNo"  value="<?php echo $paymentNo ?>">
											</th>
											<th class="form-group form-input">
											...
											if (count($records)) {
											    ...
											    ?>
													...
													<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->$pfield); ?>'">
														<td><span><?php echo $row->paymentNo ?></span></td>
														<td><span><?php echo $row->paymentDate == '0000-00-00' ? '' : date('M d,Y',strtotime($row->paymentDate)); ?></span></td>
