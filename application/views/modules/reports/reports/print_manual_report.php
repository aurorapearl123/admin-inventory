    ...
    <td colspan="3" rowspan="5" nowrap align="" class="table_row bleft btop bbottom bright">
        <table style="width: 100%;" border="0">
            ...
            <tr>
                ...
                <td valign="" align="" class="bbottom" width="200px"><slot><b><?php echo $responibilityCode ?></b></slot></td>
            </tr>
        </table>
    </td>   
    <td colspan="" rowspan="" nowrap align="" width="50px" class="table_row btop ">
        <span class="label">&nbsp;IAR No.</span></td>   
    ...
    if (!empty($records)) {
        foreach ($records as $row) { ?>
            <tr class="">
                ...
                <td colspan="" nowrap align="center" width="" class="table_row bbottom bright <?php echo (end($records))? 'btop':''; ?>"><?php echo $row['itemQty']; ?>&nbsp;</td>    
            </tr>
            <?php
            $default_rows -= 1;
            if ($row['itemAmount'] > 0) {
                    ...
                    <table class="table_header" border="0" cellpadding="0" cellspacing="0" style="">
                        ...
                        <tr>
                            ...
                            <td colspan="2" height="30px" class="bbottom" align="center">
                               ...
                               $this->db->select('inspectors.lname');
                               $this->db->select('inspectors.fname');
                               $this->db->select('inspectors.mname');
                               $this->db->from('riheaders');
                               $this->db->join('inspectors','riheaders.inspectorID=inspectors.inspectorID','left');
                               $this->db->where('iarID',$iarID);
                               $this->db->limit(1);
                               $inspector = $this->db->get()->row();
                               echo $inspector->lname.' '.$inspector->fname.' '.$inspector->mname;
                               ?> 
                               </b>
                            </td>
                            <td></td>
...
<tr>
    <td ><font size="8">APRIL 12, 2016_REV.0</font></td>
    <td align="right"><font size="8">DJRMH-HPS-MM-F-004</font></td>
</tr>
</table>