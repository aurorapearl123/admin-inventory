								...
								<table align="left" class="table table-striped hover">
									<thead>
										<tr>
											...
											<?php 
												$headers = array(
												    array('column_header'=>'RR NO','column_field'=>'rrNo','width'=>'w-5','align'=>''),
												    array('column_header'=>'RR Date','column_field'=>'rrDate','width'=>'w-5','align'=>''),
												    
												    array('column_header'=>'Supplier','column_field'=>'netAmount','width'=>'w-10','align'=>''),
												    array('column_header'=>'PO No','column_field'=>'poNo','width'=>'w-5','align'=>''),
												    array('column_header'=>'DR No','column_field'=>'drNo','width'=>'w-5','align'=>''),
												    array('column_header'=>'Plate No','column_field'=>'plateNo','width'=>'w-5','align'=>''),
												    array('column_header'=>'Driver Name','column_field'=>'driverName','width'=>'w-10','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="rrNo" name="rrNo"  value="<?php echo $rrNo ?>">
											</th>
												
											<th class="form-group form-input">
												<input type="text" class="form-control" id="rrDate" name="rrDate"  value="<?php echo $rrDate  ?>">
											</th>
											<th class="form-group form-input">
											...
											if (count($records)) {
											    ...
											    ?>
													<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->$pfield); ?>'">
														<td><span><?php echo $row->rrNo ?></span></td>
														<td><span><?php echo $row->rrDate == '0000-00-00' ? '' : date('M d,Y',strtotime($row->rrDate)); ?></span></td>
														<td><span><?php echo $row->suppName ?></span></td>
														<td><span><?php echo $row->poNo ?></span></td>
