									...
									| 
										<?php 
											if ($rec->status == 1) {
												...
												echo "<span style='color:#007bff'>PARTIALLY PAID</span>";
											} else if ($rec->status == 4){
												echo "<span style='color:#1c9980'>FULLY PAID</span>";
											} else {
						...
						<table class="view-table">
							...
							<!-- Table Rows Start -->
								...
								<tr>
									...
									<td class="data-input" nowrap><?php echo $rec->invoiceDate == '0000-00-00' ? '' :date('M d,Y',strtotime($rec->invoiceDate)); ?></td>
									<td class="data-title"></td>
								</tr>
								...
								<tr>
									...
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->dueDate == '0000-00-00 00:00:00' ? '' :date('M d,Y',strtotime($rec->invoiceDate)); ?></td>
									<td class="data-title"></td>
								</tr>
								<tr>
                        ...
                        <table id="" class="table hover">
                          <thead class="thead-light">
                            <tr>
								...
								<th class="text-right w-10" align="right">Amount</th>
								<th class="text-right w-10" align="right">Amount Paid</th>
								<th class="text-right w-10" align="right">Balance</th>
                            </tr>
                          </thead>
                          <tbody>
                        	<?php 
                        	...
                        	if (!(empty($rec)) && !(empty($details))) {                        	
                        		...
                        		<tr class="rowdetails">
	                        		...
	                        		<td align="right"><?php echo number_format($row->amount - $row->amountPaid, 2) ?></td>
