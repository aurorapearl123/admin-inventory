								...
								<tbody class="">
									<tr>
										...
										<td class="form-group form-input" width="21.33%" nowrap>
											...
											<select class="form-control " id="custID" name="custID" data-live-search="true" livesearchnormalize="true" title="Customer"  required>
												...
												<?php foreach($customers as $row) { ?>
													<option value="<?php echo $row->custID ?>" <?php if ($custID == $res->custID) { echo 'selected'; } ?>><?php echo $rec->lname.', '.$rec->fname.' '.$rec->mname; ?></option>
												<?php } ?>
											</select>
										</td>
										...
										<td class="form-group form-input" width="21.33%">
											<input type="text" class="form-control" id="soNo" name="soNo" value="<?php echo $rec->soNo ?>" title="S.O No" required>
										</td>
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control datepicker" id="soDate" name="soDate" data-toggle="datetimepicker" value="<?php echo ($rec->soDate)? date('M d, Y', strtotime($rec->soDate)) : ""; ?>" data-target="#soDate" title="Date" required>
										</td>
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" id="poNo" name="poNo" title="P.O. No" value="<?php echo $rec->poNo ?>" required>
										</td>
										<td class="form-label">Customer P.O. Date: <span class="asterisk">*</span></td>
										<td class="form-group form-input">
											<input type="text" class="form-control datepicker" id="poDate" name="poDate" data-toggle="datetimepicker" value="" data-target="#poDate" title="P.O. Date" value="<?php echo ($rec->poDate)? date('M d, Y', strtotime($rec->poDate)) : ""; ?>" required>
										</td>
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" id="balance" name="balance" title="Balance" value="<?php echo $rec->balance; ?>" readonly>
										</td>
										<td class="form-label">Due Date: <span class="asterisk">*</span></td>
										<td class="form-group form-input">
											<input type="text" class="form-control datepicker" id="dueDate" name="dueDate" data-toggle="datetimepicker" value="<?php echo ($rec->dueDate != '0000-00-00 00:00:00')? date('M d, Y', strtotime($rec->dueDate)) : ""; ?>" data-target="#dueDate" title="Due Date" required>
										</td>
										<td class="form-label"></td>
										<td class="form-group form-input">
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" id="amountPaid" name="amountPaid" title="Amount Paid" value="<?php echo $rec->amountPaid; ?>" readonly>
											
										</td>
										<td class="form-label">Date Paid: </td>
										<td class="form-group form-input">
											<input type="text" class="form-control" id="datePaid" name="datePaid" title="Date Paid" value="<?php echo ($rec->datePaid != '0000-00-00 00:00:00')? date('M d, Y', strtotime($rec->datePaid)) : ""; ?>" readonly>
										</td>
										<td class="form-label"></td>
										<td class="form-group form-input">
