								...
								<table class="table table-striped hover">
									<thead>
										<tr>
											<?php 
											$headers = array(
												array('column_header'=>'Type','column_field'=>'type','width'=>'w-10','align'=>''),
												array('column_header'=>'Expiration','column_field'=>'expiration','width'=>'w-15','align'=>''),																
												array('column_header'=>'message','column_field'=>'message','width'=>'w-40','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<select class="form-control" name="type" id="type" style="width: 150px;">
													<option value="">&nbsp;</option>
													<option value="1" <?php if ($type==1) echo "selected" ?> >Information</option>
													<option value="2" <?php if ($type==2) echo "selected" ?> >Notification</option>
													<option value="3" <?php if ($type==3) echo "selected" ?> >Warning</option>
												</select>
											</th>
											<th class="form-group form-input">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" name="message" id="message" value="<?php echo $message ?>" />
											</th>
											<th class="form-group form-input">
