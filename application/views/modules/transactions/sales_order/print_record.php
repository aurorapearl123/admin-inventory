...
.tr { height:30px;}
        ...
        <div class="btop bright bbottom bleft">            
            <table width="100%">
            	...
            	<tr>
                    <td width="20%"></td>
                    <td class="" align="center" valign="top" height="40px"><h3> SALES ORDER</h3></td>
                    <td width="20%"></td>
                </tr>
            	<tr>
                    <td></td>
            ...
            <table width="100%">
                <thead>
                    <tr class="table_header">   
                        <td width="10%" class="btop">Customer:</td>  
                        <td width="30%" class="bbottom btop"><strong><?php echo strtoupper($soheaders->lname.', '.$soheaders->fname.' '.$soheaders->mname) ?></strong></td>
                        <td width="10%" class="btop bright"></td>
                        <td width="10%" class="btop"></td>  
                        <td width="15%" class="btop">P.O. No:</td>  
                        <td width="25%" class="bbottom btop"><strong><?php echo $soheaders->poNo ?></strong></td>
                    </tr>  
                    <tr class="table_header">
                        <td>Address:</td>  
