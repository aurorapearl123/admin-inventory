				...
				<div class="card-body">
					<div class="data-view">
						<table class="view-table">
							...
							<!-- Table Rows Start -->
								<tr>
									<td class="data-title" style="width:120px" nowrap>Loyalty No:</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->loyaltyNo; ?></td>
								...
								<tr>
									...
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->lname.', '.$rec->fname. ' '.$rec->mname; ?></td>
								...
								<tr>
									<td class="data-title" nowrap>Name:</td>
									<td class="data-input" nowrap><?php echo $rec->name; ?></td>
									<td class="data-title" nowrap>Products:</td>
									<td class="data-input" nowrap><?php echo $rec->productName; ?></td>
									<td class="data-title"></td>
									<td class="data-title"></td>
								</tr>
								<tr>
									<td class="data-title" nowrap>Rank:</td>
									<td class="data-input" nowrap><?php echo $rec->rankName; ?></td>
									<td class="data-title" nowrap>Rank Points:</td>
									<td class="data-input" nowrap><?php echo $rec->rankPoints; ?></td>
									<td class="data-title"></td>
									<td class="data-title"></td>
								</tr>
								<tr>
									<td class="data-title" nowrap>Points:</td>
									<td class="data-input" nowrap><?php echo $rec->points; ?></td>
									<td class="data-title" nowrap>Peso Value:</td>
									<td class="data-input"><?php echo number_format($rec->pesoValue,2); ?></td>
									<td class="data-title"></td>
									<td class="data-title"></td>
								</tr>
								<tr>
									<td class="data-title" nowrap>Date Renewed:</td>
									<td class="data-input" nowrap><?php echo $rec->dateRenewed == '0000-00-00 00:00:00' ? '' : date('M Y',strtotime($rec->dateRenewed)); ?></td>
									<td class="data-title" nowrap>Expiry:</td>
									<td class="data-input"><?php echo date('M Y',strtotime($rec->expiry)); ?></td>
									<td class="data-title"></td>
									<td class="data-title"></td>
								</tr>
