						...
						<table class="view-table">
							...
							<!-- Table Rows Start -->
								<tr>
									...
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->rrNo; ?></td>
									<td class="data-title" style="width:120px" nowrap>RR Date:</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->rrDate == '0000-00-00' ? '' :date('M d,Y',strtotime($rec->rrDate)); ?></td>
									<td class="data-title"></td>
								</tr>
								<tr>
									<td class="data-title" style="width:120px" nowrap>DR No:</td>
									<td class="data-input" nowrap><?php echo $rec->drNo; ?></td>
									<td class="data-title" style="width:120px" nowrap>DR Date:</td>
									<td class="data-input" nowrap><?php echo $rec->drDate == '0000-00-00' ? '' :date('M d,Y',strtotime($rec->drDate)); ?></td>
									<td class="data-title"></td>
								</tr>
								<tr>
									<td class="data-title" style="width:120px" nowrap>Driver Name:</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->driverName; ?></td>
									<td class="data-title" style="width:120px" nowrap>Plate No:</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->plateNo; ?></td>
									<td class="data-title"></td>
								</tr>
								<tr>
									<td class="data-title" style="width:120px" nowrap>Driver Assistant:</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->driverAssistant; ?></td>
									<td class="data-title" style="width:120px" nowrap>Delivery Date:</td>
									<td class="data-input" style="width:420px" nowrap><?php echo $rec->timeDelivered == '0000-00-00 00:00:00' ? '' :date('M d,Y',strtotime($rec->timeDelivered)); ?></td>
									<td class="data-title"></td>
								</tr>
								<tr>
...
<script>
	...
	function confirm_record(status='') {
		...
		var id = "<?php echo $rec->rrID; ?>";
		var poID = "<?php echo $rec->poID; ?>";
		var suppID = "<?php echo $rec->suppID; ?>";
		swal({
		...
		.then((willDelete) => {
			if (willDelete.value) {
				...
				$.post("<?php echo $controller_page; ?>/confirm_record", { id: id, status: status, poID: poID, suppID: suppID },
					function(response){ 
