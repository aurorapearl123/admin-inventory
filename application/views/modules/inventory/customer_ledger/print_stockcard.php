...
<table border="0" cellpadding="0" cellspacing="0" style="width:100%;margin-top:5px;" class="table_header">
	...
	<thead align="center">
		<tr>
			...
			<th rowspan="2" width="20%" class="bright btop bbottom"><div align="center"> No. of Days to<br>Consume</div></th>
		</tr>
		<tr>
    ...
    if (!empty($records)) {
        foreach ($records as $row) { ?>
        	...
        	<tr class="">
        		...
        		<td colspan="" nowrap align="center" width="" class="table_row bbottom bright <?php echo (end($records))? 'btop':''; ?>"><?php echo $row->expiry ?></td>
        	</tr>
