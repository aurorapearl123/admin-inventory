					...
					<div class="card-head">
						...
						<div class="card-head-tools">
							<ul class="tools-list">
								...
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Print" onclick="popUp('<?php echo site_url('ancillary/printlist') ?>', 800, 500)"><i class="la la-print"></i></button>
								</li>
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Export to Excel File" onclick="window.location='<?php echo site_url('ancillary/exportlist') ?>';"><i class="la la-file-excel-o"></i></button>
								</li>
							</ul>
						</div>
					</div>
								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    array('column_header'=>'Division','column_field'=>'division','width'=>'w-10','align'=>''),
												    array('column_header'=>'Office Name','column_field'=>'officeName','width'=>'w-15','align'=>''),
													array('column_header'=>'Location','column_field'=>'location','width'=>'w-5','align'=>''),
													array('column_header'=>'Office Head','column_field'=>'officehead','width'=>'w-5','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="division" name="division" style="width:150px" value="<?php echo $division ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="officeName" name="officeName" style="width:150px" value="<?php echo $officeName ?>">
											</th>
							
											<th class="form-group form-input">
												<input type="text" class="form-control" id="location" name="location" style="width:250px" value="<?php echo $location ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="officehead" name="officehead" style="width:250px" value="<?php echo $officehead ?>">
											</th>
											<th>
									...
									<tbody>
										<?php 
											if (count($records)) {
											    ...
											    ?>
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->ancillaryID); ?>'">
											<td><?php echo $row->division ?></td>
											<td><?php echo $row->officeName ?></td>
											<td><?php echo $row->location ?></td>
											<td><?php echo $row->officehead ?></td>
											<td align="center">
												<?php 
													if ($row->status == 1) {
