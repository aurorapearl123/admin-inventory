				...
				<div class="card-head">
					...
					<div class="card-head-tools">
						<ul class="tools-list">
							...
							<?php if ($roles['edit']) {?>
							<li>
								<a href="<?php echo $controller_page.'/edit/'.$this->encrypter->encode($rec->shiftID) ?>" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit"><i class="la la-edit"></i></a>
							</li>
							<?php } ?>
				...
				<div class="card-body">
					<div class="data-view">
						<table class="view-table">
							...
							<!-- Table Rows Start -->
								<tr>
									<td class="data-title" style="width:120px" nowrap>Start Time:</td>
									<?php $timeDate = "";?>
									<td class="data-input" style="width:420px" nowrap><?php  echo  date('h:i A', strtotime($rec->startTime)); ?></td>
									<td class="data-title" style="width:120px" nowrap>End Time: </td>
									<td class="data-input" nowrap><?php echo  date('h:i A', strtotime($rec->endTime)); ?></td>
