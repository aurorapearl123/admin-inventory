            ...
            <table style="width: 100%;" class="signatory" cellspacing="0" cellpadding="1">
                <thead class="table_header">
                    ...
                    <tr class="table_header">   
                        ...
                        <td width="25%" class="bbottom "><strong><?php echo strtoupper($arheaders->companyName) ?></strong></td>
                        <td width="10%" class=" "></td>
                        <td width="10%" class=""></td>  
                        <td width="15%" class="">P.O. No:</td>  
                        <td width="25%" class="bbottom "><strong><?php echo $arheaders->invoiceNo ?></strong>&nbsp;</td>
                    </tr>  
                    <tr class="table_header">
                        <td>&nbsp;Address:</td>  
                        <td class="bbottom" style="text-decoration: underline;"><strong ><?php echo $arheaders->streetNo. ' '.$arheaders->barangay. ' '.$arheaders->city. ' '.$arheaders->province ?></strong></span></td>
                        <td class=""></td>
                        <td></td>
                        <td>Date:</td>  
                        <td class="bbottom"><strong><?php echo date('M d, Y',strtotime($arheaders->invoiceDate)) ?></strong>&nbsp;</td>
                    </tr>   
                    <tr class="table_header">   
                        <td></td>  
                        <td class="bbottom"></td>
                        ...
                        <td class="bbottom"><strong><?php echo $arheaders->modeProcurement ?></strong>&nbsp;</td>
                    </tr>  
                    <tr class="table_header">
                    ...
                    <tr>   
                        ...
                        <td class="bbottom"><strong><?php echo $arheaders->deliveryTerm ?></strong>&nbsp;</td>
                    </tr>                      
                    <tr>   
                        <td>&nbsp;Date of Delivery: </td>  
                        <td class="bbottom"><strong><?php echo date('M d, Y', strtotime($arheaders->deliveryDate)) ?></strong></td>
                        <td class=""></td>
                        <td></td>
