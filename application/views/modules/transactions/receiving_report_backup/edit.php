				...
				<div class="card-head">
					<div class="head-caption">
						<div class="head-title">
							<h4 class="head-text"> Edit <?php echo $current_module['module_label'] ?>
								 &nbsp;| &nbsp;
								<?php 
									if($rec->status==1){ 
					...
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo $controller_page.'/update'; ?>" >
								...
								<tbody>
									<tr>
										...
										<td class="form-group form-input" width="21.33%">
											...
											<input type="text" class="form-control" name="iarNo" id="iarNo" title="RR No." value="<?php echo $rec->iarNo ?>" required>
										</td>
										<td class="form-label" width="12%">IAR Date<span class="asterisk">*</span></td>
										<td class="form-group form-input" width="21.33%">
											<input type="text" class="form-control datepicker" id="iarDate" name="iarDate" data-toggle="datetimepicker" data-target="#iarDate" title="IAR Date" value="<?php echo ($rec->iarDate)? date('M d, Y', strtotime($rec->iarDate)) : ""; ?>" required>
										</td>
							...
							<table class="table-form">
								<tbody>
									<tr>
										...
										<td class="form-group form-input" width="21.33%">
											<input type="text" class="form-control" name="drNo" id="drNo" title="DR No." value="<?php echo $rec->drNo ?>">
										</td>
										<td class="form-label" width="12%">DR Date</td>
										<td class="form-group form-input" width="21.33%">
											<input type="text" class="form-control datepicker" id="drDate" name="drDate" data-toggle="datetimepicker" data-target="#drDate" title="DR Date" value="<?php echo ($rec->drDate)? date('M d, Y', strtotime($rec->drDate)) : ""; ?>" >
										</td>
										<td class="form-label" width="12%"></td>
										<td class="form-group form-input" width="21.33%">
						...
						<div class="table-row">
							<table class="table-form">
								<tbody>
									<tr>
										<td class="form-label" width="12%">Invoice No.</td>
										<td class="form-group form-input" width="21.33%">
											<input type="text" class="form-control" name="invoiceNo" id="invoiceNo" title="Invoice No." value="<?php echo $rec->invoiceNo ?>">
										</td>
										<td class="form-label" width="12%">Invoice Date</td>
										<td class="form-group form-input" width="21.33%">
											<input type="text" class="form-control datepicker" id="invoiceDate" name="invoiceDate" data-toggle="datetimepicker" data-target="#invoiceDate" title="Invoice Date" value="<?php echo ($rec->invoiceDate)? date('M d, Y', strtotime($rec->invoiceDate)) : ""; ?>" >
										</td>
										<td class="form-label" width="12%"></td>
										<td class="form-group form-input" width="21.33%">
						...
						<div class="table-row">
							<table class="table-form">
								<tbody>
									<tr>
										<td class="form-label" width="12%">Requisitioning Office<span class="asterisk">*</span></td>
										<td class="form-group form-input" width="21.33%">
											
										<input type="text" class="form-control" id="requisitioningOffice" name="requisitioningOffice" title="Requisitioning Office / Dept." value="<?php echo $rec->requisitioningOffice; ?>" required>
										</td>
										<td class="form-label" width="12%">Responsibility Center Code</td>
										<td class="form-group form-input" width="21.33%">
											<input type="text" class="form-control" id="responsibilityCenterCode" name="responsibilityCenterCode" title="Responsibility Center Code" value="<?php echo $rec->responsibilityCenterCode; ?>">
										</td>
										<td class="form-label" width="12%"></td>
										<td class="form-group form-input" width="21.33%">
						...
						<div class="table-row">
							<table class="table-form">
								<tbody>
									<tr>
										<td class="form-label" width="12%" >Delivery Type</td>
										<td class="form-group form-input" width="21.33%">
											
											<select class="form-control"  id="deliveryType" name="deliveryType" title="Delivery Type" required>
												<option value="">&nbsp;</option>
							...
							<table class="table-form">
								<tbody>
									<tr>
										...
										<td class="form-group form-input" width="21.33%">
											<textarea class="form-control" name="remarks" id="remarks" title="Remarks" rows="3"><?php echo $rec->remarks; ?></textarea>
										</td>
						...
						<!-- <div class="subtitle mt-20">
							<h5 class="title mr-auto"><i class="icon left la la-calendar"></i> IAR Details</h5>
									...
									<table id="family-members" class="table">
										<thead class="thead-light" align="center">
											<tr>
												...
												<th class="dataField w-25" nowrap>Item</th>
											...
											<tr>
												...
												<th class="form-group form-input w-10" align="left" >
													...
													<select class="form-control country" id="itemID" name="itemID" data-live-search="true" livesearchnormalize="true" title="Item"  onchange="set_default_items();" required>
														...
														<?php 
														$this->db->select('podetails.itemID');
														$this->db->select('items.name');
														$this->db->select('items.description');
														$this->db->from('podetails');
														$this->db->join('items', 'podetails.itemID=items.itemID', 'left');
														$this->db->where('podetails.poID', $rec->poID);
														$this->db->where('podetails.status', 1);
														$results = $this->db->get()->result();
														foreach($results as $res){
															?>
															<option value="<?php echo $res->itemID?>"><?php echo $res->name. ' '.$res->description; ?></option>
														<?php }?>
													</select>
												</th>
												...
												<th class="form-group form-input " align="center" >
													<input type="number" class="form-control " name="itemQty" id="itemQty" title="Item Quantity" >
												</th>
												<th class="dataField" align="left" nowrap>			
													<input type="text" class="form-control " name="itemPrice" id="itemPrice" required title="Item Price">
												</th>
												...
												<th class="" align="center">
													...
													<input type="button" class="btn btn-xs btn-primary pill" id="addItemsBtn" value=" Add " onclick="tm_add_session_item('frmAdd', 'itemID,itemUmsr,itemName,itemQty,itemPrice,itemAmount,itemDescription,itemExpiry,itemCode', 'div_items',0,'','','',0,'itemID','');" /></th>
													<th colspan="5"></th>						
												</tr>
											</thead>
											<tbody></tbody>
									...
									<table id="table_items" class="table hover">
										<thead class="thead-light" align="center">
											<tr>
												...
												<th class="w-10"><div align="left">Expiry</div></th>
...
{	
	if (check_fields2()) {
		...
		//change start
		$('#itemQty,#itemAmount,#itemPrice,#itemExpiry,#itemCode').val('');
	...
	$.ajax({
		...
		success: function(response) {
			...
			$.each(response.records, function(i, row){
				...
				list += '<td style="text-align: center;" class=" att-3">'+ row.itemCode + '</td>';
