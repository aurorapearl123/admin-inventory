        ...
        <div class="btop bright bbottom bleft">            
            ...
            <table width="100%">
                <thead>
                    <tr class="table_header">   
                        ...
                        <td width="30%" class="bbottom btop"><strong><?php echo strtoupper($poheaders->suppName) ?></strong></td>
                        <td width="10%" class="btop bright"></td>
                        <td width="10%" class="btop"></td>  
                        <td width="15%" class="btop">P.O. No:</td>  
                        <td width="25%" class="bbottom btop"><strong><?php echo $poheaders->poNo ?></strong></td>
                    </tr>  
                    <tr class="table_header">
                        <td>Address:</td>  
                        <td class="bbottom" style="text-decoration: underline;"><strong ><?php echo $poheaders->streetNo. ' '.$poheaders->barangay. ' '.$poheaders->city. ' '.$poheaders->province ?></strong></span></td>
                        <td class="bright"></td>
                        <td></td>
                        <td>Date:</td>  
                        <td class="bbottom"><strong><?php echo date('M d, Y',strtotime($poheaders->poDate)) ?></strong></td>
                    </tr>   
                    <tr class="table_header">   
                        <td></td>  
                        <td class="bbottom"></td>
                        ...
                        <td class="bbottom"><strong><?php echo $poheaders->modeProcurement ?></strong></td>
                    </tr>  
                    <tr class="table_header">
				...
				<table width="100%">  
                    ...
                    <tr>   
                        ...
                        <td width="30%" class="bbottom"><strong><?php echo $poheaders->deliveryPlace ?></strong></td>
                        <td width="10%"></td>
                        <td width="15%" class="bleft">Delivery Term:</td>  
                        <td width="25%" class="bbottom"><strong><?php echo $poheaders->deliveryTerm ?></strong></td>
                    </tr>                      
                    <tr>   
                        <td>Date of Delivery: </td>  
                        <td class="bbottom"><strong><?php echo date('M d, Y', strtotime($poheaders->deliveryDate)) ?></strong></td>
                        <td></td>
                        <td class="bleft">Payment Term:</td>  
                        <td class="bbottom"><strong><?php echo $poheaders->paymentTerm ?></strong></td>
                    </tr> 
                    <tr>   
                ...
                <?php
                  ...
                  <?php }  } ?>
                    ...
                    <tr class="">
                        ...
                        <td colspan="" nowrap align="center" width="" class="table_row bbottom bright"></td>
                        <td colspan="2" nowrap align="center" width="" class="table_row bbottom bright"><strong>-------------------------------------------------</strong></td>
                        <td colspan="" nowrap align="center" width="" class="table_row bbottom bright"></td>    
                        <td colspan="" nowrap align="center" width="" class="table_row bbottom bright"></td>    
                    ...
                    <tr class="">
                        <td colspan="" nowrap align="center" width="" class="table_row bbottom  bright"></td>  
                        <td colspan="" nowrap align="center" width="" class="table_row bbottom bright"></td>
                        <td colspan="2" nowrap align="left" width="" class="table_row bbottom bright"><strong><?php echo $poheaders->remarksdetails?></strong></td>
                        <td colspan="" nowrap align="center" width="" class="table_row bbottom bright"></td>    
                        <td colspan="" nowrap align="center" width="" class="table_row bbottom bright"></td>    
			...
			<table width="1000px">                
                <tr>                    
                    ...
                    <td width="25%" class="table_row bbottom" align="left"><strong><?php echo $poheaders->alobsno ?></strong></td>
                ...
                <tr>                    
                    ...
                    <td class="table_row" align="left"><strong><?php echo '&#8369; '. number_format($totalAmount, 2); ?></strong></td>
                    <td class="bright table_row" align="center"></td>             
                </tr>                  
            </table>
        </div>
