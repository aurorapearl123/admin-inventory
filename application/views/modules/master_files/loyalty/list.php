					...
					<div class="card-head">
						...
						<div class="card-head-tools">
							<ul class="tools-list">
								...
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Print" onclick="popUp('<?php echo site_url('loyalty/printlist') ?>', 800, 500)"><i class="la la-print"></i></button>
								</li>
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Export to Excel File" onclick="window.location='<?php echo site_url('loyalty/exportlist') ?>';"><i class="la la-file-excel-o"></i></button>
								</li>
							</ul>
						</div>
					</div>
								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    array('column_header'=>'Loyalty No','column_field'=>'loyaltyNo','width'=>'w-15','align'=>''),
												    array('column_header'=>'Customer','column_field'=>'custID','width'=>'w-15','align'=>''),
												    array('column_header'=>'Name','column_field'=>'name','width'=>'w-15','align'=>''),
												    array('column_header'=>'Rank','column_field'=>'rankID','width'=>'w-15','align'=>''),
												    array('column_header'=>'Expiry','column_field'=>'expiry','width'=>'w-15','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="suppName" name="suppName"  value="<?php echo $loyaltyNo ?>">
											</th>

											<th class="form-group form-input">
												<input type="text" class="form-control" id="custID" name="custID"  value="<?php echo $custID ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="name" name="name"  value="<?php echo $name ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="rankID" name="rankID"  value="<?php echo $rankID ?>">
											</th>
											<th class="form-group form-input">
									...
									<tbody>
										<?php 
											if (count($records)) {
											    ...
											    ?>
											<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->loyaltyID); ?>'">
											<td><?php echo $row->loyaltyNo ?></td>
