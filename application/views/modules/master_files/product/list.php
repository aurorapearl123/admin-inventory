								...
								<table class="table table-striped hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
													array('column_header'=>'Category','column_field'=>'category','width'=>'w-15','align'=>''),
													array('column_header'=>'Product Code','column_field'=>'productCode','width'=>'w-15','align'=>''),		
													array('column_header'=>'Product','column_field'=>'name','width'=>'w-15','align'=>''),
													array('column_header'=>'Price','column_field'=>'avecost','width'=>'w-10','align'=>''),
													array('column_header'=>'Reorder Lvl','column_field'=>'reorderLvl','width'=>'w-5','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="category" name="category" style="width:200px" value="<?php echo $category ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="productCode" name="productCode" style="width:200px" value="<?php echo $productCode ?>">												
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="name" name="name" style="width:200px" value="<?php echo $name ?>">
											</th>										
											<th class="form-group form-input">
												<!-- <input type="text" class="form-control" id="avecost" name="avecost" style="width:150px" value="<?php echo $avecost ?>"> -->
											</th>
											<th class="form-group form-input">
												<!-- <input type="text" class="form-control" id="reorderLvl" name="reorderLvl" style="width:100px" value="<?php echo $reorderLvl ?>"> -->
											</th>
											<th class="form-group form-input">
									...
									<tbody>
										...
										<tr onclick="location.href='<?php echo $controller_page.'/view/'.$this->encrypter->encode($row->$pfield); ?>'">
											...
											<td align="left"><?php echo $row->productCode ?></td>
											<td align="left"><?php echo $row->name ?></td>
											<td align="right"><?php echo number_format($row->avecost,2) ?></td>
											<td align="right"><?php echo number_format($row->reorderLvl) ?></td>											
											<td align="center">
												<?php 
													if ($row->status == 1) {
										...
										<?php } else { ?>
										<tr>
											<td nowrap="nowrap" colspan="6" align="center"><b><i>No result found.</i></b></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
