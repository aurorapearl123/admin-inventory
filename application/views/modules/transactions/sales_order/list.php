								...
								<table align="left" class="table table-striped hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    array('column_header'=>'SO NO','column_field'=>'soNo','width'=>'w-5','align'=>''),
												    array('column_header'=>'Date','column_field'=>'soDate','width'=>'w-10','align'=>''),
												    ...
												    array('column_header'=>'Due Date','column_field'=>'deliveryDate','width'=>'w-5','align'=>''),
												    array('column_header'=>'Delivery Date','column_field'=>'deliveryDate','width'=>'w-5','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="soNo" name="soNo"  value="<?php echo $soNo ?>">
											</th>
												
											<th class="form-group form-input">
												<!-- <input type="text" class="form-control" id="soDate" name="soDate"  value="<?php echo $soDate  ?>"> -->
											</th>
											<th class="form-group form-input">
											...
											<th class="form-group form-input">
												<!-- <input type="text" class="form-control" id="dueDate" name="dueDate"  value="<?php echo $dueDate ?>"> -->
											</th>
											<th class="form-group form-input">
												<!-- <input type="text" class="form-control" id="deliveryDate" name="deliveryDate"  value="<?php echo $deliveryDate ?>"> -->
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="paymentTerm" name="paymentTerm"  value="<?php echo $paymentTerm ?>">
											</th>
											<th>
											...
											if (count($records)) {
											    ...
											    ?>
													<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->$pfield); ?>'">
														<td><span><?php echo $row->soNo ?></span></td>
														<td><span><?php echo $row->soDate == '0000-00-00' ? '' : date('M d,Y',strtotime($row->soDate)); ?></span></td>
														<td><span><?php echo $row->lname.', '.$row->fname.' '.$row->mname; ?></span></td>
														<td><span><?php echo $row->netAmount ?></span></td>
														<td><span><?php echo $row->balance ?></span></td>
														<td><span 
																<?php 
														...
														<td><span><?php echo $row->deliveryDate == '0000-00-00' ? '' : date('M d,Y',strtotime($row->deliveryDate)); ?></span></td>
														<td><span><?php echo $row->paymentTerm ?></span></td>
														<td align="center">
															<?php 
															if ($row->status == 1) {
