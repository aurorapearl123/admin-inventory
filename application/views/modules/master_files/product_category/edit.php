	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				...
				<div class="card-body">
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url('product_category/update') ?>">
...
<script>
	...
	$('#cmdCancel').click(function(){
	    ...
	    .then((willDelete) => {
	      if (willDelete.value) {
	    	  window.location = '<?php echo site_url('product_category/view/'.$this->encrypter->encode($rec->catID)) ?>';
	      }
	    });
	});
</script>
