	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				...
				<div class="card-body">
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url("inspector/save") ?>">
						<div class="table-row">
								...
								<tbody>
									<tr>
										...
										<td class="form-group form-input" width="400px" nowrap>
											<input type="text" class="form-control" name="inspectorpin" id="inspectorpin" maxlength="6" title="Inspector PIN" style="width:100px" required>
										</td>
										<td>&nbsp;</td>
									</tr>
									<tr>
...
<script>
	$('#cmdSave').click(function(){
		if (check_fields()) {
	        ...
	        $.post("<?php echo $controller_page ?>/check_duplicate", { pin: $('#inspectorpin').val() },
	          function(data){
	            if (parseInt(data)) {
	...
	$('#cmdCancel').click(function(){
		swal({
		    ...
		    .then((willDelete) => {
		      if (willDelete.value) {
		    	  window.location = '<?php echo site_url('inspector/show') ?>';
		      }
		    });
