 ...
 */
class Loyalty_ranks extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->_init_setup('Master Files', 'Loyalty_ranks', 'loyalty_ranks', 'rankID', 'rankID');
		//change end
	}
    ...
    private function _init_setup($module='',  $controller='', $table='', $pfield='', $logfield='')
    {
        ...
        $this->module_label = 'Loyalty Ranks';
    ...
    private function submenu()
    {
        ...
        //change start
        $this->data['current_module'] = $this->modules[$this->module]['sub']['Loyalty Ranks']; // defines the current sub module
        //change end
    ...
    public function save()
    {
        ...
        //change start
        $table_fields = array('rankName','pointsRequired');
        //change end
        ...
        if ($this->roles['create']) {
            ...
            if ($this->record->save()) {
                ...
                $logs = "Insert - " . trim($this->input->post('rankName'));
                $this->log_model->table_logs($data['current_module']['module_label'], $this->table, $this->pfield, $this->record->field->$pfield, $id,'Insert', $logs);
    ...
    public function update()
    {
        ...
        //change start
        $table_fields = array('rankName','pointsRequired','status');
        //change end
    ...
    public function show()
    {
        ...
        $condition_fields = array(                       
            array('variable'=>'rankName', 'field'=>$this->table.'.rankName', 'default_value'=>'', 'operator'=>'like_both'),
            array('variable'=>'pointsRequired', 'field'=>$this->table.'.pointsRequired', 'default_value'=>'', 'operator'=>'like_both'),           
         	array('variable'=>'status', 'field'=>$this->table.'.status', 'default_value'=>'1', 'operator'=>'where')
        );
        
        // sorting fields
        $sorting_fields = array('pointsRequired'=>'desc');
        //change end
        //=========================
    ...
    public function exportlist()
    {
        ...
        if (count($records)) {
            ...
            foreach ($records as $row) {
                ...
                $data .= "<Cell ss:StyleID='s27'><Data ss:Type='String'>" . $row->pointsRequired . "</Data></Cell>";     
                if ($row->status == 1) {
    ...
    {
        //change start
        $this->db->where('rankName', trim($this->input->post('rankName')));       
        //change end
