                       ...
                       // var_dump($jobs);
									...
									<tr>
										...
										<td class="form-group form-input">
											...
											echo $this->htmlhelper->select_object('employeeTypeID', $data, 'employeeTypeID', 'employeeType', 330, $employeeTypeID, 'getJobPositions();', '', 'tabindex="15"');
											?>
										</td>
										<td class="form-label" width="12%">
										</td>
									...
									<tr>
										...
										<td class="form-group form-input">
											...
											echo $this->htmlhelper->select_object('jobPositionID', $data, 'jobPositionID', 'jobTitle', 330, $jobPositionID, '', '', 'tabindex="20"');
											?>
										</td>
										<td class="form-label" width="12%">
										</td>
									...
									<tr>
										...
										<td class="form-group form-input" width=""  colspan="5" rowspan="3">
											<textarea class="form-control" name="qualifications" id="qualifications" rows="5" maxlength="50" style="width:500px"></textarea>
										</td>
									...
									<tr>
										...
										<td class="form-group form-input" height="200" width="21.33%">
											<textarea style="" class="form-control" name="remarks" id="remarks"/></textarea>
										</td>
										<td class="form-label" width="12%">
										</td>
										<td class="form-group form-input" width="21.33%">
