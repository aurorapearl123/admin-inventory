								...
								<tbody>
									<tr>
										...
										<td class="form-group form-input" width="400px" nowrap>
											<input type="text" class="form-control" name="bankName" id="bankName" title="Bank Name" value="<?php echo $rec->bankName?>" required>
										</td>
									...
									<tr>
										...
										<td class="form-group form-input" width="400px" nowrap>
											<input type="text" class="form-control" name="bankAcronym" id="bankAcronym" title="Bank Acronym" value="<?php echo $rec->bankAcronym?>" required>
										</td>										
										<td class="form-label" ></td>
										<td class="form-label" ></td>
									</tr>									
