 ...
 */
class Medical_supplies extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->_init_setup('Reports', 'medical_supplies', 'stockcards', 'id', 'id');
		//change end
	}
    ...
    private function submenu()
    {
        ...
        //change start
        $this->data['current_module'] = $this->modules[$this->module]['sub']['Inventory of Available Medical Supplies']; // defines the current sub module
        //change end
      ...
      //  $offset = 0;
        ...
        if (count($records)) {
            ...
            foreach ($records as $row) {
              ...
              $data .= "<Cell ss:StyleID='mRight'><Data ss:Type='String'></Data></Cell>";
              $data .= "<Cell ss:StyleID='s23'><Data ss:Type='String'>TOTAL RECEIPT AMOUNT: </Data></Cell>";
    ...
    public function print_record($dateYear, $dateMonth, $ancillaryID)
    {
        ...
        if ($this->roles['view']) {
            ...
            $this->mpdf->Output("MEDICAL_SUPPLIES.pdf","I");
