								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    array('column_header'=>'Code','column_field'=>'code','width'=>'w-10','align'=>''),
												    array('column_header'=>'Name','column_field'=>'fullname','width'=>'w-10','align'=>''),
												    array('column_header'=>'Designation 1','column_field'=>'designation1','width'=>'w-10','align'=>''),
												    array('column_header'=>'Designation 2','column_field'=>'designation2','width'=>'w-10','align'=>''),
												    array('column_header'=>'Designation 3','column_field'=>'designation3','width'=>'w-10','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="code" name="code"  value="<?php echo $code ?>" style="width:100px">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="fullname" name="fullname"  value="<?php echo $fullname ?>" style="width:200px">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="designation1" name="designation1"  value="<?php echo $designation1 ?>" style="width:200px">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="designation2" name="designation2"  value="<?php echo $designation2 ?>" style="width:200px">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="designation3" name="designation3"  value="<?php echo $designation3 ?>" style="width:200px">
											</th>
											<th>
									...
									<tbody>
										<?php 
											if (count($records)) {
											    ...
											    ?>
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->signatoryID); ?>'">
