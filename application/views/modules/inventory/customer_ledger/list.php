                                ...
                                <table class="table table-striped hover">
                                    <thead align="center">
                                        <tr>
                                            <?php 
                                                $headers = array(
                                                    ...
                                                    array('column_header'=>'STOCK NO.','column_field'=>'productCode','width'=>'w-10','align'=>''),
                                                    array('column_header'=>'PRODUCT DESCRIPTION','column_field'=>'name','width'=>'w-20','align'=>''),
                                                    array('column_header'=>'CATEGORY','column_field'=>'catID','width'=>'w-20','align'=>''),
                                                    array('column_header'=>'ENDING BAL','column_field'=>'endBal','width'=>'w-20','align'=>''),
                                        ...
                                        <tr id="filter-group" class="collapse multi-collapse table-filter show">
                                            ...
                                            <th class="form-group form-input">
                                                <input type="text" class="form-control" id="productCode" name="productCode" value="<?php echo $productCode ?>">
                                            </th>
                                            <th class="form-group form-input">
                                    ...
                                    <tbody align="center">
                                        ...
                                        ?>
                                        <tr onclick="location.href='<?php echo $controller_page.'/view/'.$this->encrypter->encode($row->productID).'/'.$this->encrypter->encode($row->ancillaryID); ?>'">
                                             
                                            <td><?php echo $row->companyName ?></td>
                                            <td><?php echo $row->productCode ?></td>
                                            <td align="center"><?php echo $row->name.' '.$row->description ?></td>
                                           
                                            <td align="center"><?php echo $row->category ?></td>
                                            <td align="center"><?php echo $row->endBal ?></td>
