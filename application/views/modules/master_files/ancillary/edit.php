	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				...
				<div class="card-body">
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url('ancillary/update') ?>">
		
						<input type="hidden" name="ancillaryID" id="ancillaryID" value="<?php echo $this->encrypter->encode($rec->ancillaryID) ?>" />
						<div class="table-row">
								...
								<tbody>
									<tr>
										...
										<td class="form-group form-input" style="width:400px" nowrap>
											<input type="text" class="form-control" name="division" id="division" title="Division" value="<?php echo $rec->division?>" required>
										</td>
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" name="officeName" id="officeName" title="Office Name" value="<?php echo $rec->officeName?>" required>
										</td>
										<td class="d-xxl-none"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" name="officehead" id="officehead" value="<?php echo $rec->officehead?>" title="Office Head" required>
										</td>
										<td class="d-xxl-none"></td>
									</tr>
									<tr>
