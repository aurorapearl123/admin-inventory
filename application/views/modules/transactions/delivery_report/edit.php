								...
								<tbody class="">
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control" id="driverName" name="driverName" title="Driver Name" value="<?php echo $rec->driverName ?>">
										</td>
										<td class="form-label">Plate No: </td>
										<td class="form-group form-input">
											<input type="text" class="form-control" id="plateNo" name="plateNo" title="Plate No" value="<?php echo $rec->plateNo ?>">
										</td>
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control datepicker" id="departure" name="departure" data-toggle="datetimepicker" value="" data-target="#departure" title="Delivery Date" value="<?php echo ($rec->departure)? date('M d, Y', strtotime($rec->departure)) : ""; ?>">
										</td>
										<td class="form-label"></td>
										<td class="form-group form-input">
							...
							<form method="post" name="frmAdd" id="frmAdd" ><!-- Form Start -->
								...
								<table id="" class="table">
									<thead class="thead-light" align="center">
										...
										<tr>
											<th>
												<select id="custID" name="custID" class="form-control" data-live-search="true" liveSearchNormalize="true" title="Customers" onchange="get_po_customers();" required>
													
													<?php 
													$this->db->where('status >', 0);
													$this->db->where('custID', $rec->custID);
													$results = $this->db->get('customers')->result();
													foreach($results as $res){
														?>
														<option value="<?php echo $res->custID?>" selected><?php echo $res->companyName; ?></option>
													<?php }?>
												</select>
											</th>
											<th>
												<select id="soID" name="soID" class="form-control" data-live-search="true" liveSearchNormalize="true" title="Sales Order" onchange="get_po_select_products();" required>
													
													<?php 
													$this->db->where('status', 2);
													$this->db->where('soID', $rec->soID);
													$results = $this->db->get('soheaders')->result();
													foreach($results as $res){
														?>
														<option value="<?php echo $res->soID?>" selected><?php echo $res->soNo; ?></option>
													<?php }?>
												</select>
											</th>
...
//change end
echo $this->htmlhelper->get_json_select('get_po_customers', $parameters, site_url('generic_ajax/get_po_customers'), 'soID', '', '') ;
