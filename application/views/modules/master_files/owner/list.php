								...
								<table class="table table-striped hover">
									<thead>
										<tr>
											<?php 
												$headers = array(													
													array('column_header'=>'Last Name','column_field'=>'lastName','width'=>'w-15','align'=>''),
													array('column_header'=>'First Name','column_field'=>'firstName','width'=>'w-15','align'=>''),													
													array('column_header'=>'Middle Name','column_field'=>'middleName','width'=>'w-10','align'=>''),
													array('column_header'=>'User Name','column_field'=>'userName','width'=>'w-15','align'=>''),													
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="lname" name="lname" style="width:200px" value="<?php echo $lastName ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="fname" name="fname" style="width:200px" value="<?php echo $firstName ?>">	
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="middleName" name="middleName" style="width:200px" value="<?php echo $middleName ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="userName" name="userName" style="width:200px" value="<?php echo $userName ?>">
											</th>
											<th class="form-group form-input">
									...
									<tbody>
										...
										<tr onclick="location.href='<?php echo $controller_page.'/view/'.$this->encrypter->encode($row->$pfield); ?>'">
											...
											<td><?php echo $row->lastName ==''?'-': $row->lastName ?></td>
											<td><?php echo $row->firstName == ''?'-': $row->firstName?></td>
											<td><?php echo $row->middleName ==''?'-':$row->middleName ?></td>
