...
class Supplier extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->_init_setup('Master Files', 'supplier', 'suppliers', 'suppID', 'suppID');
		//change end
	}
    ...
    private function submenu()
    {
        ...
        //change start
        $this->data['current_module'] = $this->modules[$this->module]['sub']['Supplier']; // defines the current sub module
        //change end
    ...
    public function save()
    {
        ...
        //change start
        $table_fields = array('suppName', 'contactNo', 'contactperson','email','streetNo','barangayID','cityID','provinceID');
        //change end
        ...
        if ($this->roles['create']) {
            ...
            if ($this->record->save()) {
                ...
                $logs = "Insert - " .trim($this->input->post('suppName'));
    ...
    {   
        ...
        if ($this->roles['edit']) {
			...
			$this->record->joins[]	= array('barangays',$this->table.'.barangayID=barangays.barangayID','left');
			$this->record->joins[]	= array('cities',$this->table.'.cityID=cities.cityID','left');
			$this->record->joins[]	= array('provinces',$this->table.'.provinceID=provinces.provinceID','left');
    ...
    public function update()
    {
        ...
        //change start
          $table_fields = array('suppName', 'contactNo', 'contactperson','email','streetNo','barangayID','cityID','provinceID','status');
        //change end
    ...
    public function show()
    {
        ...
        $condition_fields = array(
			array ('variable' => 'suppName', 'field' => $this->table . '.suppName', 'default_value' => '', 'operator' => 'like_both' ), 
			array ('variable' => 'contactNo', 'field' => $this->table . '.contactNo', 'default_value' => '', 'operator' => 'like_both' ), 
        ...
        // sorting fields
        $sorting_fields = array('suppName'=>'asc');
        //change end
        //=========================
    ...
    public function exportlist()
    {
        ...
        if (count($records)) {
            ...
            foreach ($records as $row) {
                ...
                $data .= "<Cell ss:StyleID='s27'><Data ss:Type='String'>" . $row->contactperson . "</Data></Cell>";
        ...
        // Final XML Blurb
        $filename = ucfirst($this->data['controller_name']).'_list';
