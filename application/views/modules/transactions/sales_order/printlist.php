 ...
 <tr style="font-weight: bold;font-size: 11px;">
    ...
    <td class="top left" align="center">DELIVERY DATE</td>
...
?>
        <tr>
            ...
            <td class="top left"><?php echo date("M d, Y",strtotime($row->soDate));  ?></td>
            ...
            <td class="top left"><?php echo date("M d, Y",strtotime($row->deliveryDate)); ?></td>
