...
class Transactions extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->logfield     = 'empNo';
        $this->module_path  = 'modules/transactions/transactions';           
        $this->data['controller_page']  = $this->controller_page = site_url('transactions');
    ...
    private function submenu()
    {
        ...
        $this->data['current_module']   = $this->modules[$this->module]['sub']['Transactions'];      // defines the current sub module
        // check roles
        $this->check_roles();
