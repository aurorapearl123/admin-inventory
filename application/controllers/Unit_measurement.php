...
class Unit_measurement extends CI_Controller {
	//Default Variables
	var $menu;
	var $roles;
	var $data;
	...
	public function __construct() {
		...
		$this->data['controller_page'] = $this->controller_page = site_url('unit_measurement'); // defines contoller link
		$this->table = 'unit_measurements'; // defines the default table
		$this->pfield = $this->data['pfield'] = 'umsrID'; // defines primary key
		$this->logfield = 'umsr';
		$this->module_path = 'modules/'.strtolower(str_replace(" ", "_", $this->module)) . '/Unit_Measurement'; // defines module path
	...
	private function submenu() {
		...
		$this->data['current_module'] = $this->modules[$this->module]['sub']['Unit Measurement']; // defines the current sub module
		// check roles
		$this->check_roles ();
...
//	}
	...
	public function update() {
		...
		$this->submenu ();
		$data = $this->data;
		$table_fields = array ('umsr','status');
	...
	public function printlist() {
		...
		$data ['title'] = "Unit of Measurement List";
	...
	function exportlist() {
		...
		$data .= "<Cell ss:MergeAcross='2'><Data ss:Type='String'></Data></Cell>";
		$data .= "</Row>";
		
		$data .= "<Row ss:StyleID='s20'>";
		$data .= "<Cell ss:MergeAcross='2'><Data ss:Type='String'>".$companyName."</Data></Cell>";
		$data .= "</Row>";
		$data .= "<Row ss:StyleID='s24A'>";
		$data .= "<Cell ss:MergeAcross='2'><Data ss:Type='String'>".$address."</Data></Cell>";
		$data .= "</Row>";
		...
		$data .= "<Row ss:StyleID='s24'>";
		$data .= "<Cell ss:MergeAcross='2'><Data ss:Type='String'>".strtoupper($title)."</Data></Cell>";
		$data .= "</Row>";
