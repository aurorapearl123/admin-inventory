            ...
            <table style="width: 100%;" class="signatory" cellspacing="0" cellpadding="1">
                <thead class="table_header">
                    ...
                    <tr class="table_header">   
                        ...
                        <td width="25%" class="bbottom "><strong><?php echo strtoupper($poheaders->suppName) ?></strong></td>
                        <td width="10%" class=" "></td>
                        <td width="10%" class=""></td>  
                        <td width="15%" class="">P.O. No:</td>  
                        <td width="25%" class="bbottom "><strong><?php echo $poheaders->poNo ?></strong>&nbsp;</td>
                    </tr>  
                    <tr class="table_header">
                        <td>&nbsp;Address:</td>  
                    ...
                    <tr>   
                        ...
                        <td class="bbottom"><strong><?php echo $poheaders->deliveryTerm ?></strong>&nbsp;</td>
                    </tr>                      
                    <tr>   
