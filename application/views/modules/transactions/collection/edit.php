								...
								<tbody class="">
									<tr>
										...
										<td class="form-group form-input" width="21.33%">
											<input type="text" class="form-control" id="collectionNo" name="collectionNo" title="Collection No" value="<?php echo $rec->collectionNo ?>" required>
										</td>
										<td class="form-label" width="12%">Collection Date: <span class="asterisk">*</span></td>
										<td class="form-group form-input" width="21.33%">
											<input type="text" class="form-control datepicker" id="collectionDate" name="collectionDate" data-toggle="datetimepicker" value="<?php echo ($rec->collectionDate)? date('M d, Y', strtotime($rec->collectionDate)) : ""; ?>" data-target="#collectionDate" title="Collection Date" required>
										</td>
