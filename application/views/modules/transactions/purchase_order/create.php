								...
								<tbody class="">
									<tr>
										...
										<td class="form-group form-input" width="21.33%">
											<input type="text" class="form-control" id="poNo" name="poNo" title="P.O No" value="<?php echo $series ?>" required>
										</td>
									...
									<tr>
										...
										<td class="form-label">PO Date: <span class="asterisk">*</span></td>
										<td class="form-group form-input">
											<input type="text" class="form-control datepicker" id="poDate" name="poDate" data-toggle="datetimepicker" value="<?php echo date('M d, Y')?>" data-target="#poDate" title="Date" required>
										</td>
									...
									<tr>
										...
										<td class="form-group form-input">
											<input type="text" class="form-control datepicker" id="dueDate" name="dueDate" data-toggle="datetimepicker" value="" data-target="#dueDate" title="Due Date">
