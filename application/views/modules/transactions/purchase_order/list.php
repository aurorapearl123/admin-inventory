								...
								<table align="left" class="table table-striped hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    ...
												    array('column_header'=>'Date','column_field'=>'poDate','width'=>'w-10','align'=>''),
												    ...
												    array('column_header'=>'Payment Status','column_field'=>'paymentTerm','width'=>'w-5','align'=>''), 
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											...
											<th class="form-group form-input">
												<!-- <input type="text" class="form-control" id="poDate" name="poDate"  value="<?php echo $poDate  ?>"> -->
											</th>
											<th class="form-group form-input">
											...
											if (count($records)) {
											    ...
											    ?>
													<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->$pfield); ?>'">
														...
														<td><span><?php echo $row->poDate == '0000-00-00' ? '' : date('M d,Y',strtotime($row->poDate)); ?></span></td>
														...
														<td align="center">
															...
															if ($row->paymentStatus == 1) {
																...
																echo "<span class='badge badge-pill badge-success'>Fully Paid</span>";
															} else {
																echo "";
															}
															?>
