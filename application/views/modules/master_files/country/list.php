					...
					<div class="card-head">
						...
						<div class="card-head-tools">
							<ul class="tools-list">
								...
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Print" onclick="popUp('<?php echo site_url('country/printlist') ?>', 800, 500)"><i class="la la-print"></i></button>
								</li>
								<li>
									<button type="button" class="btn btn-outline-light bmd-btn-icon" data-toggle="tooltip" data-placement="bottom" title="Export to Excel File" onclick="window.location='<?php echo site_url('country/exportlist') ?>';"><i class="la la-file-excel-o"></i></button>
								</li>
							</ul>
						</div>
					</div>
								...
								<table class="table table-striped has-img hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    array('column_header'=>'Code','column_field'=>'countryCode','width'=>'w-10','align'=>''),
												    array('column_header'=>'Country','column_field'=>'country','width'=>'w-5','align'=>''),
												    array('column_header'=>'Nationality','column_field'=>'nationality','width'=>'w-5','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											<th class="form-group form-input">
												<input type="text" class="form-control" id="countryCode" name="countryCode" style="width:150px" value="<?php echo $countryCode ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="country" name="country" style="width:150px" value="<?php echo $country ?>">
											</th>
											<th class="form-group form-input">
												<input type="text" class="form-control" id="nationality" name="nationality" style="width:150px" value="<?php echo $nationality ?>">
											</th>
											<th class="form-group form-input">
									...
									<tbody>
										<?php 
											if (count($records)) {
											    ...
											    ?>
										<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->countryID); ?>'">
