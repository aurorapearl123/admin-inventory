...
class Customer_ledger extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->_init_setup('Inventory', 'customer_ledger', 'customer_ledger', 'id', 'refNo');
        //change end
    }
    ...
    private function submenu()
    {
        ...
        //change start
        $this->data['current_module'] = $this->modules[$this->module]['sub']['Customer Ledger']; // defines the current sub module
        //change end
    ...
    public function show()
    {
        ...
        // sorting fields
        $sorting_fields = array('companyName'=>'asc','id'=>'desc');
        //change end
        //=========================
        ...
        $this->db->group_by($this->table.'.custID');
