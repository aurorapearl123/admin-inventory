...
class Banks extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->_init_setup('Master Files', 'banks', 'banks', 'bankID', 'bankID');
		//change end
	}
    ...
    private function submenu()
    {
        ...
        //change start
        $this->data['current_module'] = $this->modules[$this->module]['sub']['Banks']; // defines the current sub module
        //change end
    ...
    public function save()
    {
        ...
        //change start
        $table_fields = array('bankName', 'bankAcronym');
        //change end
        ...
        if ($this->roles['create']) {
            ...
            if ($this->record->save()) {
                ...
                $logs = "Insert - " . trim ( $this->input->post ( 'bankName' ) ) ;
    ...
    public function update()
    {
        ...
        //change start
          $table_fields = array('bankName', 'bankAcronym', 'status');
        //change end
    ...
    public function show()
    {
        ...
        $condition_fields = array(
			array ('variable' => 'bankName', 'field' => $this->table . '.bankName', 'default_value' => '', 'operator' => 'like_both' ), 
			array ('variable' => 'bankAcronym', 'field' => $this->table . '.bankAcronym', 'default_value' => '', 'operator' => 'like_both' ), 			
			array ('variable' => 'status', 'field' => $this->table . '.status', 'default_value' => '', 'operator' => 'where' ) 
        );
        
        // sorting fields
        $sorting_fields = array('bankName'=>'asc');
        //change end
        //=========================
    ...
    public function exportlist()
    {
        ...
        if (count($records)) {
            ...
            foreach ($records as $row) {
                ...
                $data .= "<Cell ss:StyleID='s27'><Data ss:Type='String'>" . $row->bankAcronym . "</Data></Cell>";
                if ($row->status == 1) {
    ...
    {
        //change start
        $this->db->where('bankName', trim($this->input->post('bankName')));
        //change end
