	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				...
				<div class="card-body">
					<form method="post" name="frmEntry" id="frmEntry" action="<?php echo site_url("item_subcategory/save") ?>">
						<div class="table-row">
							<table class="table-form column-3">
								<tbody>
									...
									<tr>
										...
										<td class="form-group form-input" width="400px" nowrap>
											<input type="text" class="form-control" name="subcatdesc" id="subcatdesc" title="Description" required></td>
										<td class="d-xxl-none"></td>
									</tr>
								</tbody>
							</table>
...
<script>
	$('#cmdSave').click(function(){
		if (check_fields()) {
	        ...
	        $.post("<?php echo $controller_page ?>/check_duplicate", { subcatID: subcatID, subcatdesc: subcatdesc },
	          function(data){
	            if (parseInt(data)) {
	...
	$('#cmdCancel').click(function(){
		swal({
		    ...
		    .then((willDelete) => {
		      if (willDelete.value) {
		    	  window.location = '<?php echo site_url('item_subcategory/show') ?>';
		      }
		    });
