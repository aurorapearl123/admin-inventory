								...
								<table align="left" class="table table-striped hover">
									<thead>
										<tr>
											<?php 
												$headers = array(
												    ...
												    array('column_header'=>'Customer Name','column_field'=>'companyName','width'=>'w-10','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											...
											<th class="form-group form-input">
												<!-- <input type="text" class="form-control" id="invoiceDate" name="invoiceDate"  value="<?php echo $invoiceDate  ?>"> -->
											</th>
											<th class="form-group form-input">
