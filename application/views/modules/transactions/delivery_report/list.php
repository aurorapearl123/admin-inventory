								...
								<table align="left" class="table table-striped hover">
									<thead>
										<tr>
											...
											<?php 
												$headers = array(
												    array('column_header'=>'DR NO','column_field'=>'drNo','width'=>'w-5','align'=>''),
												    array('column_header'=>'DR Date','column_field'=>'drDate','width'=>'w-5','align'=>''),
												    
												    array('column_header'=>'Customer','column_field'=>'companyName','width'=>'w-10','align'=>''),
												    array('column_header'=>'SO No','column_field'=>'soNo','width'=>'w-5','align'=>''),
												    
												    array('column_header'=>'Plate No','column_field'=>'balance','width'=>'w-5','align'=>''),
												    array('column_header'=>'Driver Name','column_field'=>'deliveryDate','width'=>'w-10','align'=>''),
												    array('column_header'=>'Departure','column_field'=>'departure','width'=>'w-5','align'=>''),
										...
										<tr id="filter-group" class="collapse multi-collapse table-filter show">
											...
											<th class="form-group form-input">
												<!-- <input type="text" class="form-control" id="drDate" name="drDate"  value="<?php //echo $drDate  ?>"> -->
											</th>
											<th class="form-group form-input">
											...
											<th class="form-group form-input">
												<!-- <input type="text" class="form-control" id="departure" name="departure"  value="<?php echo $departure ?>"> -->
											</th>
											<th>
											...
											if (count($records)) {
											    ...
											    ?>
													<tr onclick="location.href='<?php echo $controller_page."/view/".$this->encrypter->encode($row->$pfield); ?>'">
														<td><span><?php echo $row->drNo ?></span></td>
														<td><span><?php echo $row->drDate == '0000-00-00' ? '' : date('M d,Y',strtotime($row->drDate)); ?></span></td>
														<td><span><?php echo $row->companyName ?></span></td>
														<td><span><?php echo $row->soNo ?></span></td>
														<td><span><?php echo $row->plateNo ?></span></td>
														<td><span><?php echo $row->driverName ?></span></td>
														<td><span><?php echo $row->departure == '0000-00-00' ? '' : date('M d,Y',strtotime($row->departure)); ?></span></td>
														<td align="center">
															<?php 
															if ($row->status == 1) {
